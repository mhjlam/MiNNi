...
def train_network(model, X, y, epochs=100):
    ...
    ani.save(os.path.join(example.OUTPUT_DIR, "multiclass_quadratic-net.mp4"), writer="ffmpeg", fps=30)
...
def train_plot(model, X, y, epochs=100):
    ...
    ani.save(os.path.join(example.OUTPUT_DIR, "multiclass_quadratic-fit.mp4"), writer="ffmpeg", fps=30)
...
def main():
    ...
    train_plot(model, X, y, epochs=500)
